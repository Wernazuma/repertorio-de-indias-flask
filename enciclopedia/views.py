...
###### ROUTES ######
####################
@enciclopedia_bp.route('/')
def index():
    return render_template('enciclopedia_home.html')

# Route for the discovery page
@enciclopedia_bp.route('/')
def index():
    ...
    return render_template('discover.html', places=places_count, territories=territories_count, officials=officials_count)
...
@encyclopedia_bp.route('/place/<place_id>')
...
@encyclopedia_bp.route('/territory/<territory_id>')
...
@encyclopedia_bp.route('/people/persIndias<OficialID>')
...
@encyclopedia_bp.route('/people/search', methods=['GET', 'POST'])
def people_search():
...
@encyclopedia_bp.route('/territory/search', methods=['GET'])
...
@encyclopedia_bp.route('/place/search', methods=['GET', 'POST'])
def place_search():
...
@encyclopedia_bp.route('/fuentes/<source_id>')
...
@encyclopedia_bp.route('/categoria/<gz_id>')
...
### Download routes ###
#######################
@encyclopedia_bp.route('/territory/download', methods=['GET'])
...
@encyclopedia_bp.route('/place/download', methods=['GET'])
def place_download():
    normalization_cache = {}
...
### Helper routes ###
#####################
@encyclopedia_bp.route('/get_subcategories/<category>')
...
@encyclopedia_bp.route('/data/historia_gz_entidades/<path:filename>')
def historia_lugar(filename):
    ...
    if os.path.isfile(os.path.join(directory, filename)):
        ...
        abort(404)
@encyclopedia_bp.route('/data/historia_entidades/<path:filename>')
