...
@app.route('/api/process_domain', methods=['POST'])
...
@app.route('/api/save_column_types', methods=['POST'])
...
@app.route('/api/get_field_mapping_info', methods=['GET'])
...
@app.route('/api/process_final', methods=['POST'])
