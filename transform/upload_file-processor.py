...
@app.route('/save_column_types', methods=['POST'])
...
@app.route('/save_chronological_info', methods=['POST'])
...
@app.route('/run_places_matching', methods=['GET'])
def run_places_matching():
    ...
    try:
        ...
        matched_path = os.path.join(app.config['UPLOAD_FOLDER'], matched_filename)
